...
@admin.register(VoucherProcess)
class VoucherProcessAdmin(admin.ModelAdmin):
    list_display = (
        "attempt_id",
        "journal_id_snapshot",
        "organization",
    ...
    list_filter = ("status", "gl_status", "inventory_status", "organization")
    search_fields = ("attempt_id", "journal_id_snapshot", "error_code", "correlation_id")
    readonly_fields = (
        "attempt_id",
        "journal",
        "journal_id_snapshot",
