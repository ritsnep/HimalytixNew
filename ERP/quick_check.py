...
codes = ['sales-invoice-vm-si', 'VM08', 'journal-entry-vm-je', 'VM-SI', 'VM-PI', 'VM-SO', 'VM-PO', 'VM-GR', 'VM-SCN', 'VM-SDN', 'VM-SR', 'VM-SQ', 'VM-SD', 'VM-PCN', 'VM-PDN', 'VM-PR', 'VM-LC']
...
for code in codes:
    ...
    if exists:
        ...
        ui_fields = len(config.ui_schema.get('sections', {}).get('header', {}).get('fields', {}))
